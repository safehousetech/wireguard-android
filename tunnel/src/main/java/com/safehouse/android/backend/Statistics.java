...
package com.safehouse.android.backend;

import android.os.SystemClock;

import com.safehouse.crypto.Key;
import com.safehouse.util.NonNullForAll;
...
public class Statistics {
     ...
     * @param rxBytes           The received traffic for the {@link com.safehouse.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes
     * @param txBytes           The transmitted traffic for the {@link com.safehouse.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes.
     * @param latestHandshake   The timestamp of the latest handshake for the {@link com.safehouse.config.Peer}
     *                          referenced by the provided {@link Key}. The value is in epoch milliseconds.
     * @param blocked           The counter of error dns responses {@link com.safehouse.config.Peer}
    ...
    /**
     * Get the statistics for the {@link com.safehouse.config.Peer} referenced by the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link com.safehouse.config.Peer}.
     ...
     * {@link com.safehouse.config.Peer}s
     */
    public Key[] peers() {
